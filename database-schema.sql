...
CREATE TABLE IF NOT EXISTS chat_messages (
    ...
    message_type TEXT DEFAULT 'text', -- 'text', 'command', 'tool_output'
    metadata JSONB, -- For storing command results, tool outputs, etc.
    created_at TIMESTAMPTZ DEFAULT NOW()
);
...
-- Admin permissions (includes manager permissions)
